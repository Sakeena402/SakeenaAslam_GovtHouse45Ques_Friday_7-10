...
var current_users = ['admin', 'Areeb', 'Amna', 'Sakeena', 'Ahmed'];
var new_users = ['Sarim', 'Areeb', 'Ameena', 'Sehrish', 'Ahmed'];
for (var _i = 0, new_users_1 = new_users; _i < new_users_1.length; _i++) {
    ...
    for (var _a = 0, current_users_1 = current_users; _a < current_users_1.length; _a++) {
        ...
        if (new_user.toLowerCase() === current_user.toLowerCase()) {
            console.log("".concat(new_user, " is taken, you need to enter a new name"));
            isTaken = true;
            break;
        }
    }
